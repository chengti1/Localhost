...
'day_type' => 'short',
'show_next_prev' => TRUE,
'next_prev_url' => 'http://www.landtechnology.com.hk/proejcts/codeigniter/app_cal/show/',
'template' => $tpl
);
...
$data['app_name'] = array('name' => 'app_
name', 'id' => 'app_name', 'value' => set_value('app_name', ''),
'maxlength' => '100', 'size' => '35');
$data['app_description'] = array('name' =>
'app_description', 'id' => 'app_description', 'value' => set_
value('app_description', ''), 'maxlength' => '100', 'size' =>
'35');
$days_in_this_month = days_in_month($month,$year);
$days_i = array();
for ($i=1;$i<=$days_in_this_month;$i++) {
($i<10 ? $days_i['0'.$i] = '0'.$i : $days_i[$i] =
$i) ;
}
$data['days'] = $days_i;
$data['months'] = array('01' => 'January','02' =>
'February','03' => 'March','04' => 'April','05' => 'May','06' =>
'June','07' => 'July','08' => 'August','09' => 'September','10' =>
...
$data = array(
'app_name' => $this->input->post('app_
name'),
'app_description' => $this->input->post('app_
description'),
'app_date' => $app_date,
'app_url' => base_url('index.php/app_
cal/appointment/'.$year.'/'.$month.'/'.$day)
);
...
$this->form_validation->set_rules('app_id', 'Appointment
ID', 'min_length[1]|max_length[11]|is_natural|trim');
if ($this->form_validation->run() == FALSE) { // First load, or problem with form
...
$month = $this->uri->segment(4);
$day = $this->uri->segment(5);
$data['appointments'] = $this->App_cal_model->get_

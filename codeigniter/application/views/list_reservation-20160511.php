...
<?php endblock() ?>
<?php startblock('css') ?>
<link href="http://www.landtechnology.com.hk/projects/boat/lessimportant.css" rel="stylesheet">
                        ...
                        if (isset($view_free_boat) && is_array($view_free_boat) && count($view_free_boat)) {
                            ...
                            foreach ($view_free_boat as $key => $free_reservation_data) {
                                ...
                                ?>>
                                    ...
                                    <td style="vertical-align:middle"><?php echo $free_reservation_data['freeboat']; ?></td>

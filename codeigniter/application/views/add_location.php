	...
	<div class="col-md-7">
		...
		<div class="form-group">
            ...
            <?php foreach ($view_location as $key=>$locationdata) {?>
                ...
                <option value="<?php echo $locationdata['newlocation'];?>"<?php if($locationdata['newlocation'] == set_value('newlocation') ) { echo 'selected'; } ?>><?php echo $locationdata['newlocation'];?></option>           
	...
	<div class="col-md-7 col-sm-12 col-xs-12">
		...
		<div class="form-group">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
				...
				<div><a id="customer_receipt_file_link" href="javascript:"><!-- <span class="btn"> --><img src="<?php echo base_url();?>assets/images/upload_photo.png" class="img-responsive"><!-- </span> --></a></div>

...
<?php
     ...
     // if(isset($view_data) && is_array($view_data) && count($view_data)): $i=1;
      ...
      foreach ($edit_owner as $key => $data) {

 ?> 	

 			

<form class="form-horizontal" method="post" action="<?php echo site_url('Welcome/update_owner/'.$data['id'].''); ?>" name="data_register">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-2">
				...
				<input type="text" class="form-control" name="lastname" value="<?php echo $data['owner_lastname']; ?> " placeholder="姓氏">

			</div>

			<div class="col-xs-5">

				<input type="text" class="form-control" name="firstname" value="<?php echo $data['owner_name']; ?>" placeholder="姓名">
...
<!-- 			<div class="col-xs-9">
				...
				<input type="text" class="form-control" name="owner_name" value="<?php echo $data['owner_name']; ?>">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="owner_company" value="<?php echo $data['owner_company']; ?>">
...
<!-- 	<div class="col-md-9">
		...
		<div class="form-group">
			...
			<div class="col-xs-9">
				...
				<input type="text" class="form-control" name="company_photo" value="<?php echo $data['company_photo']; ?>">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="owner_phone" value="<?php echo $data['owner_phone']; ?>" >
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="owner_phone2" value="<?php echo $data['owner_phone2']; ?>">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="email" value="<?php echo $data['owner_email']; ?>">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="owner_address" value="<?php echo $data['owner_address']; ?>">
	...
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<input type="text" class="form-control" name="loginid" value="<?php echo $data['login']; ?>">
...
<script type="text/javascript">
    ...
    var uploader_thumb = new plupload.Uploader({
        ...
        url : '<?php echo site_url('Upload/temp_upload_image') ?>',

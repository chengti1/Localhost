...
var jqDialog = new function() {
	...
	this.init = function() {
		...
		this.btYes = $('<button class="btn">').attr({ id: this.btYesName }).append( document.createTextNode(this.strYes) );
		this.btNo = $('<button class="btn grey">').attr({ id: this.btNoName }).append( document.createTextNode(this.strNo) );
